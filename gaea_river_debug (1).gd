...
@export var water_y_offset: float = 100.0
...
func setup() -> void:
	...
	_mesh_instance.position = Vector3(512.0, water_y_offset, 512.0)
	...
	mat.set_shader_parameter("water_surface_offset", water_y_offset)
	mat.set_shader_parameter("debug_show_all", 0.0)
